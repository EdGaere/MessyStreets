# -*- coding: utf-8 -*-
"""
messy_streets/v0/generators/v3: Generate addresses based on OA+OSD with augmented country names
...
BASE
messy_streets/v0/generators/v2

MODIFICATIONS
1. allow --config from CLI to re-use configuration from a benchmark => reproducibility

2. new outputs
    * jaccard_1     : lexical similarity between the WDC surface form and the OA/OSM surface form
    * trigram_1.    : lexical similarity between the WDC surface form and the OA/OSM surface form
    * levenshtein_1 : lexical similarity between the WDC surface form and the OA/OSM surface form
    * iso-2         : standardised country code; e.g. "Großbritannien", "GB" => GB
    * un_region     : United Nations region
    * continent     : Continent
    
3. directly plot histograms of output values using --hist from CLI
...
- has(country)      : if the component is displayed, e.g. 'country', generate 'Yes', else 'No'
                      components : country, locality, region, street, postcode
...
# lexical overlap with reference address
python3 v3.py jaccard_1 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --hist --save analysis/release_gold
python3 v3.py jaccard_1 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --hist --save analysis/release_silver

python3 v3.py trigram_1 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --hist --save analysis/release_gold
python3 v3.py trigram_1 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --hist --save analysis/release_silver

python3 v3.py levenshtein_1 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --hist --save analysis/release_gold
python3 v3.py levenshtein_1 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --hist --save analysis/release_silver

# geographic distribution
python3 v3.py iso2 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py iso2 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver
python3 v3.py iso2 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw

python3 v3.py un_region 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py un_region 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver
python3 v3.py un_region 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw

python3 v3.py continent 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py continent 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver
python3 v3.py continent 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw

# components : country, locality, region, street, postcode
python3 v3.py "has(street)" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "has(street)" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "has(street)" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre

python3 v3.py "has(country)" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "has(country)" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "has(country)" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre

python3 v3.py "has(region)" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "has(region)" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "has(region)" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre

python3 v3.py "has(postcode)" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "has(postcode)" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "has(postcode)" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre

python3 v3.py "has(locality)" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "has(locality)" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "has(locality)" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre

# source
python3 v3.py "source" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "source" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre

# script
python3 v3.py "script" 1000 --config messy_streets/release_gold_geohash1_1 --stop_on_error --counts --save analysis/release_gold
python3 v3.py "script" 1000 --config messy_streets/release_silver_pre_geohash1_1 --stop_on_error --counts --save analysis/release_silver_pre
python3 v3.py "script" 1000 --config messy_streets/release_raw_geohash1_1 --stop_on_error --counts --save analysis/release_raw_pre
...
from serentec.utils.strings.lexical_similarity import jaccard_similarity, trigram_similarity, levenshtein_similarity
from serentec.utils.strings.dominant_script import dominant_script

# serentec: analysis
from serentec.utils.analysis.histogram import plot_histogram, plot_counts
from serentec.utils.analysis.descriptive_stats import DescriptiveStats

# serentec: logging
from serentec.utils.logger import logger_dl
module_logger = logger_dl.getChild("messy_streets/v3")
...
COUNTRY_SUFFIX = compile(r"\s*\([^)]*\)\s*$")  # trailing "(...)"
...
class Generate:
    ...
    def __init__(self, debug : bool = False, debug2 : bool = False):
        ...
        self.country_converter = CountryConverter()

        self.country_suffix_regex = compile(COUNTRY_SUFFIX)
        ...
        self.COUNTRY_OVERRIDES = {
            ...
            , "deutschland": "DE"
            , "المملكة المتحدة": "GB"      # Arabic: United Kingdom
            , "nederland": "NL"
            , "españa": "ES"
            , "espagne": "ES"             # French: Spain
            , "българия": "BG"            # Bulgarian: Bulgaria
            , "österreich": "AT"
            , "gruzja": "GE"              # Polish: Georgia
            , "pays bas": "NL"            # French: Netherlands
            , "estados unidos": "US"
            , "lietuva": "LT"
            , "latvija": "LV"
            , "ελλάδα": "GR"              # Greek: Greece
            , "suède": "SE"              # French: Sweden
            , "美国": "US"                # Chinese: United States
            , "großbritannien": "GB"          # German: United Kingdom
            , "norge": "NO"                   # Norwegian: Norway
            , "slovenská republika": "SK"     # Slovak: Slovakia
            , "oostenrijk": "AT"              # Dutch: Austria
            , "verenigd koninkrijk": "GB"     # Dutch: United Kingdom
            , "spanien": "ES"                 # German: Spain
            , "sverige": "SE"                 # Swedish: Sweden
            , "italien": "IT"                 # German: Italy
            , "србија": "RS"                  # Serbian Cyrillic: Serbia
            , "espanha": "ES"                 # ⚠ see note
        }
    ...
    def passes_filter(self, record: dict, conditions: list[str]) -> bool:
        """
        Evaluate all filter conditions against a record.

        :param record: Field-value mapping for one record.
        :param conditions: Expressions referencing fields by bare name,
            e.g. ["jaccard_1 < 0.43"].
        :return: True only if every condition evaluates truthy.
        """
        for condition in conditions:
            if not simple_eval(condition, names=record):
                return False
        return True

    def normalise_country(self, raw: str, to : str = "ISO2", not_found : str = None) -> str | None:
        """
        Resolve a country surface form to an ISO2 code.

        :param raw: Raw country string (name, ISO2, ISO3, any language).
        :return: ISO2 code, or None if unresolved.
        """
        if not raw:
            return None
        cleaned = self.country_suffix_regex.sub("", raw.strip())
        key = cleaned.lower()

        if key in self.COUNTRY_OVERRIDES:
            return self.COUNTRY_OVERRIDES[key]

        code = self.country_converter.convert(cleaned, to=to, not_found=not_found)
    ...
    def generate(self
        ...
        :param filters: optional; if specified, a list of filters to be evaluated
            e.g. ["jaccard_1 < 0.43"]
        ...
        if filters is not None:
            check_isinstance(filters, list)

            if self.debug:
                module_logger.debug(f"{len(filters)} filter specified | {filters}")
        ...
        db_path = cache_path / md5("+".join(databases).encode("UTF-8")).hexdigest()

        if self.debug:
            module_logger.debug(f"db_path : {db_path}")
        ...
        if "addresses" not in tables:
            ...
            module_logger.debug(f"Materialising addresses...")
        ...
        def address_generator(batch_size : int, seed: int | None = None):
            ...
            batch_num = 0
            while True:
                #seed_clause = f", seed={seed + batch_num}" if seed is not None else ""
                if seed is not None:
                    sample_clause = f"USING SAMPLE reservoir({batch_size} ROWS) REPEATABLE({seed + batch_num})"
                else:
                    sample_clause = f"USING SAMPLE {batch_size}"

                if self.debug:
                    module_logger.debug(f"Sampling {batch_size} rows...")
        ...
        while observation_idx < num_observations:
            ...
            try:
                ...
                # debugging: keep track of original objects
                __address_source = address_source
                __original_random_address = random_address.copy()

                # METHODOLGY: use the lon/lat of the WDC record, because the WDC address is what the geocoder will see
                ...
                # record the original database where the record came from, either OA or OSD
                try:
                    address_root_source = loads(random_record["aux"])[0]["source"]
                    check_isinstance(address_root_source, str)
                    assert address_root_source in ('oa', 'osd')
                except:
                    if "class" in random_record["payload"]:
                        address_root_source = "wdc"
                    else:
                        raise ValueError(f"Unknown source for address | {random_record}")


                # METHODOLOGY: for measuring accuracy loss due to the messy address and other metrics we can toggle the source to OA/OSD and use the cleaner version as baseline
                require_source_address = toggle_source or filters is not None or output in('jaccard_1', 'trigram_1', 'levenshtein_1')
                source_address = None
                if require_source_address:
                    if self.debug:
                        module_logger.debug("Retrieving source address...")

                    #module_logger.debug(random_record)
                    ...
                    #print("source_rows", source_rows[0])
                    ...
                    if self.debug:
                        module_logger.debug("source_address", source_address)
                
                if toggle_source:
                    check_isinstance(source_address, dict)
                    ...
                    # METHODOLGY: use the lon/lat of the source record, since the geocoder will see address components from the source and thus the inferred coordinates should be compared against OA/OSD
                    latitude = float(random_address["latitude"]) if "latitude" in random_address else float(random_address["lat"])
                    longitude = float(random_address["longitude"]) if "longitude" in random_address else float(random_address["lon"])
                ...
                if toggle_source and self.debug:
                    # show the original input seqauence
                    input_str_wdc, _, _ = self.render(address=__original_random_address
                                                                            , source=__address_source
                                                                            , format_spec=format_spec
                                                                            , separators=separators
                                                                            , schemas=schemas
                                                                            , remove_random_component_probability=remove_random_component_probability
                    ...
                    module_logger.debug(f"Source toggle | WDC : {input_str_wdc} | ouptut (from '{address_root_source}') : {input_str}")
            ...
            # similarity metrics
            # lexical similarity between the WDC surface form and the OA/OSM surface form
            # render the source address from OA/OSM with the same rendering as for the WDC one
            similarity_metrics = None
            if filters is not None or output in ('jaccard_1', 'trigram_1', 'levenshtein_1'):
                check_isinstance(source_address, dict)
                
                source_str, _, _ = self.render(address=source_address
                                                , source=source_record_db
                                                , format_spec=format_spec
                                                , separators=separators
                                                , schemas=schemas
                                                , remove_random_component_probability=remove_random_component_probability
                ...
                similarity_metrics = {
                    "jaccard_1" : jaccard_similarity(input_str, source_str)
                    , "trigram_1" : trigram_similarity(input_str, source_str)
                    # NOTE: levenshtein similarity = 1.0 - levenshtein distance
                    , "levenshtein_1" : levenshtein_similarity(input_str, source_str)
                    }

            # apply filters
            if filters is not None:
                assert similarity_metrics is not None
                # populate filter criteria
                filter_values = {
                    "source" : address_root_source
                    , "script" : dominant_script(input_str)
                                 }
                filter_values.update(similarity_metrics)
                
                # execute the filter
                filter_passed = self.passes_filter(filter_values, filters)
                
                if self.debug:
                    module_logger.debug(f"Applying filters | {filter_values} | pass : {filter_passed}")
            ...
            # for NER (named entity resolution)
                ...
                output_str = address_root_source
            
            elif output == "script": 
                output_str = dominant_script(input_str)
            ...
            elif similarity_metrics is not None and output in similarity_metrics: 
                # lexical similarity between the WDC surface form and the OA/OSM surface form
                output_str = similarity_metrics[output]
                ...
                country_value = token_values.get("country", 'NULL')
                countrycode = self.normalise_country(country_value, to="ISO2", not_found='NULL')
                output_str = countrycode

            elif output == 'un_region':
                country_value = token_values.get("country", 'NULL')
                if country_value != "NULL":
                    countrycode = self.normalise_country(country_value, to="ISO2", not_found='NULL')
                    output_str = self.country_converter.convert(countrycode, src="ISO2", to='UNregion', not_found='NULL')
                else:
                    output_str = "NULL"
                

            elif output == 'continent':
                country_value = token_values.get("country", 'NULL')
                if country_value != "NULL":
                    countrycode = self.normalise_country(country_value, to="ISO2", not_found='NULL')
                    output_str = self.country_converter.convert(countrycode, src="ISO2", to='continent', not_found='NULL')
                else:
                    output_str = "NULL"
...
if __name__ == "__main__":
    ...
    cmd_line_parser.add_argument('--hist', default=False, dest='hist', action='store_true', help='show histogram of output values (continuous)')
    cmd_line_parser.add_argument('--counts', default=False, dest='counts', action='store_true', help='show histogram of output values (categorical)')
    cmd_line_parser.add_argument('--save', type=str, default=None, help="save stats to a folder; folder is created if it does not yet exist; e.g. analysis/release_gold")
    cmd_line_parser.add_argument('--overwrite', default=False, dest='overwrite', action='store_true', help='overwrite stats')
    ...
    if args.config is None:
        ...
        #
        # USAGE
        # python3 v3.py geohash7 10 --config messy_streets/release_gold_geohash1_1 --debug --stop_on_error
    ...
    for idx, (training_pair, _) in enumerate(results):
        ...
        elif args.targets or args.hist or args.counts:
    ...
    print(f"runtime : {elapsed_time_str}")
    ...
    if args.hist:
        hist = plot_histogram(
        values=outputs
        , title=f"Distribution of {args.output}"
        , xlabel=args.output
        )

        stats = DescriptiveStats(outputs, label=args.output).as_dict()
    
    elif args.counts:
        
        stats = plot_counts(outputs, title=f"Distribution of {args.output}", xlabel=args.output)
    ...
    # save stats
    if stats is not None and args.save:
        ...
        output_field_clean = args.output
        summary_filename = save_path / f"{output_field_clean}.json"
        if summary_filename.exists():
            if not args.overwrite:
                raise RuntimeError(f"Output sumamry {summary_filename} already exists")

        with open(summary_filename, "w", encoding='utf8') as json_file:
            json_file.write(dumps(summary))
