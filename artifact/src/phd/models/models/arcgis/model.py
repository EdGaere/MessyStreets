"""
model.py: wrapper for geopy/ArgGis (ESRI) geolocation/geocoding service

NOTES
* anonymous rate-limmited access
...
class Model(ModelBase):
    ...
    def __init__(self
        ...
        self.geolocator = ArcGIS(user_agent="Edward Gaere's PhD / Paper2"
                                 , timeout=30
                                 , ssl_context=ctx
                                 )
